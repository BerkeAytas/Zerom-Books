                              ...
                              children: <Widget>[
                                Padding(
                                  ...
                                  child: Container(
                                    ...
                                    //Image.asset("assets/images/profilphoto.jpg",width: size.width * 0.3,semanticLabel: 'Fotoğraf Seçin',)),
                                  ),
                                ),
                                Text(
                                  "Berke Aytas",
                            ...
                            Expanded(
                                ...
                                child: Row(
                                  children: <Widget>[
                                    ...
                                    Column(
                                      children: <Widget>[
                                        Text("Kendine Hoş Geldin", style: TextStyle(fontWeight: FontWeight.bold)),
                                        Text("Zerom Yayıncılık"),
                                        Text(
                                          "40.50",
                                          style: TextStyle(color: Colors.brown),
                                        ),
